...
// This is a config file that connects to MongoDB and loads all of our models for us. We do this here because we don't want to connect to the DB every time we require a model!
// require mongoose
